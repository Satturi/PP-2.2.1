...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      carServise.add(new Car("Car1", 1));
      carServise.add(new Car("Car2", 2));
      carServise.add(new Car("Car3", 3));
      carServise.add(new Car("Car4", 4));
      ...
      System.out.println(userService.getByCar("Car1", 1));
      context.close();
   }
}
